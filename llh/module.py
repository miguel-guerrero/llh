...
class Module:
    ...
    def interface(self):
        assert False, f"please override 'interface' method for Module {self.modName}"

    def params(self):
        return []

    def logic(self):
        assert False, f"please override 'logic' method for Module {self.modName}"
    ...
    def createInput(self, name: str, T=None):
        ...
        port = In(name=name, T=copy.deepcopy(T), parent=self, vcdHandle=vcdHandle)
    ...
    def createOutput(self, name: str, T=None):
        ...
        assert isinstance(T, LV)
        vcdHandle = gSim.vcdRegister(self.hierInstanceName(), name, T.width())
        port = Out(name=name, T=copy.deepcopy(T), parent=self, vcdHandle=vcdHandle)
